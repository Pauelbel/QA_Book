**Это процесс**, который гарантирует, что все процессы, методы, действия и рабочие элементы разработки программного обеспечения отслеживаются и соответствуют установленным стандартам
